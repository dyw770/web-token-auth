...
public class SystemEventBeanConfiguration {
    ...
    @Bean
    @Role(BeanDefinition.ROLE_INFRASTRUCTURE)
    public Advisor systemEventAdvisor(BeanFactory beanFactory, SystemEventHandler systemEventHandler) {
        SystemEventInterceptor interceptor = new SystemEventInterceptor(systemEventHandler);
    ...
    @Bean
    public SystemEventHandler defaultSystemEventHandler() {
        return new DefaultSystemEventHandler();
    }
}
