...
import static cn.dyw.auth.cache.configuration.RedisCacheAutoConfiguration.defaultConfiguration;
...
public class CustomRedisCacheAutoConfiguration extends RedisConnectionConfiguration {

    private final AuthCacheProperties cacheProperties;

    public CustomRedisCacheAutoConfiguration(AuthCacheProperties properties,
